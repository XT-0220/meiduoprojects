# Generated by Django 2.2.5 on 2020-07-18 16:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subs', to='contents.GoodsCategory', verbose_name='父类别')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(default=20, on_delete=django.db.models.deletion.SET_DEFAULT, to='contents.GoodsChannelGroup', verbose_name='频道组名')),
            ],
            options={
                'verbose_name': '商品频道',
